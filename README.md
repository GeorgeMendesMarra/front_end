...
A estrutura atual do repositório reúne exemplos de **Angular, React, JavaScript, JavaServer Faces, JavaServer Pages, Java Struts e aplicações/projetos de controle**, além dos exemplos introdutórios `site1` e `site2`. ([GitHub][1])
...
[1]: https://github.com/GeorgeMendesMarra/front_end/tree/main "GitHub - GeorgeMendesMarra/front_end: Repositório público do Professor George Mendes Marra sobre Front-End · GitHub"
